...
cellphonedb method statistical_analysis /local1/USERS/tomasgomes/CellPhoneDB_runs_updt/healthy/healthy_meta_names.txt /local1/USERS/tomasgomes/CellPhoneDB_runs_updt/healthy/healthy_exp_norm.txt --threads=12 --output-path=/local1/USERS/tomasgomes/liver/CellPhoneDB_runs_updt/healthy --project-name healthy --counts-data gene_name

cellphonedb method statistical_analysis /local1/USERS/tomasgomes/CellPhoneDB_runs_updt/healthy_simp/healthy_meta_names.txt /local1/USERS/tomasgomes/CellPhoneDB_runs_updt/healthy_simp/healthy_exp_norm.txt --threads=12 --output-path=/local1/USERS/tomasgomes/liver/CellPhoneDB_runs_updt/healthy_simp --project-name healthy_simp --counts-data gene_name
...
Load data to make cell comm networks
...
```{r}
save(edge_cond_umap_df, point_cond_umap_df, file = "results/cell_comm/networks_cond_umap.RData")
save(pe_umap_l, pe_umap_cond_l_ch, 
     file = "results/cell_comm/median_networks_cond_umap.RData")
```
