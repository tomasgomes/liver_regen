...
pdf("figure_panels_rev2/fig_comm/endo_expression_angiocrine.pdf", height = 4.8, width = 6)
print(plt_mean)
dev.off()
```
...
```{r}
inter_df = readRDS(file = "results/cell_comm/v3/cond_diff_interact_DE.RDS")[1:3]
...
pdf("figure_panels_rev2/fig_comm/endo_interactions_angiocrine_allInter.pdf", height = 4.45, 
    width = 6.8)
print(cnt_int_cond)
dev.off()
```
...
pdf("figure_panels_rev2/fig_comm/endo_interactions_angiocrine_healthyVSPVE.pdf", height = 4.45, 
    width = 6.8)
print(cnt_int_spec)
dev.off()
```
...
pdf("figure_panels_rev2/fig_comm/endo_interactions_angiocrine_any2cond.pdf", height = 4.45, 
    width = 6.8)
print(cnt_int_spec2)
dev.off()
```
...
write.csv(inter_df_sub, file = "figure_panels_rev2/fig_comm/endo_interactions_angiocrine.csv",
          row.names = F, quote = F)
