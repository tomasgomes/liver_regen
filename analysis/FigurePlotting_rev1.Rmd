...
plt = ggplot(plot_df[plot_df$variable %in% c("cirr_ct_MPs_4","cirr_ct_MPs_5"),], 
       aes(x = mono_annot, y = value, fill = Condition))+
...
plot_df$Condition[plot_df$Condition=="embolised"] = "embolized"
plt = ggplot(plot_df[plot_df$variable %in% c("cirr_ct_Endothelia_6","cirr_ct_Endothelia_7"),], 
