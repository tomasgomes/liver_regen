...
save(edge_cond_umap_df, point_cond_umap_df, 
     file = "results/cell_comm/v3/networks_cond_umap.RData")
save(pe_umap_l, pe_umap_cond_l_ch, 
     file = "results/cell_comm/v3/median_networks_cond_umap.RData")
save(pe_umap_mid_l, pe_umap_cond_l_mid, 
     file = "results/cell_comm/v3/median_networks_cond_umap_midct.RData")
```
