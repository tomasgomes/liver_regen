...
```{r}
saveRDS(comph_inters, file = "results/cell_comm/updt/comph_inters.RDS")
...
save(pe_mid_l, pe_cond_l_mid, 
     file = "results/cell_comm/updt/median_networks_cond_midct.RData")
```
...
```{r}
save(edge_cond_umap_df, point_cond_umap_df, 
     file = "results/cell_comm/updt/networks_cond_umap.RData")
save(pe_umap_l, pe_umap_cond_l_ch, 
     file = "results/cell_comm/updt/median_networks_cond_umap.RData")
save(pe_umap_mid_l, pe_umap_cond_l_mid, 
     file = "results/cell_comm/updt/median_networks_cond_umap_midct.RData")
```
