...
DimPlot(hep_cells$healthy, reduction = "umap", group.by = "hep_res.0.2")
hep_cells$healthy = SetIdent(hep_cells$healthy, value = "hep_res.0.2")
...
for(cond in names(end_cells)){
  print(cond)
  # will only use variable genes
  hvg = end_cells[[cond]]@assays$SCT@var.features
