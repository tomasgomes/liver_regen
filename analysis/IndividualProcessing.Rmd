...
dat_matches = c("EKS.data", "sc_H1", "HD1", "EKS","cells","healthy", "Exp1","No",
                ...
                "data.Reg1.NHep", "sc_E1", "DD1", "HEP", "cells", "embolised", "Exp2","Yes",
                "data.Reg1.RHep","sc_R1", "DD1", "HEP", "cells", "regenerating", "Exp2","Yes",
                ...
                "sn_H3", "sn_H3", "HD3", "all", "nuclei", "healthy", "Exp1","No",
                "sn_H4", "sn_H4", "HD4", "all", "nuclei", "healthy", "Exp1","No")
...
plotDoubletGMM = function(l){
  ...
  cond_scores = getDoubletScores(l)
  gmm_cond = tapply(cond_scores$scrublet_score, cond_scores$orig.ident, 
                    normalmixEM, k = 2)
...
Plot number of read distribution

```{r}
all_meta = Reduce(rbind, lapply(cond_srat, function(x) x@meta.data))
all_meta$frac_exp_tec = paste(all_meta$Fraction, all_meta$Experiment, 
                              all_meta$Reseq, sep = "_")
...
```{r}
sub_cond = cond_srat[c("data.Reg1.NHep","Data.Reg6_HepE","Hep2N.data", 
                       "Data.Reg5_HepE","Data.Reg7_HepR","Data.Reg6_npcR")]
...
DimPlot(sub_cond$Data.Reg6_npcR, reduction = "umap", group.by = "SCT_snn_res.0.6")
FeaturePlot(sub_cond$Data.Reg6_HepE, features = c("FGA", "FGB"))
```
...
dat_filt = list("EKS.data" = c(0.25, 0.3, 15, 1000, 800, 40000, 6000),
             "NPC.data" = c(0.25, 0.3, 15, 1000, 800, 40000, 6000),
             "HEP.data" = c(0.3, 0.3, 40, 1000, 800, 40000, 6000),
             "Hep.2d.data" = c(0.3, 0.3, 40, 1000, 800, 40000, 6000),
             "NPC.2d.data" = c(0.25, 0.3, 15, 1000, 800, 40000, 6000),
             "Hep.3d.data" = c(0.3, 0.3, 40, 1000, 800, 40000, 6000),
             "NPC.3d.data" = c(0.25, 0.3, 15, 1000, 800, 40000, 6000),
                
             "data.Reg1.NHep" = c(0.4, 0.35, 20, 1000, 800, 40000,6000),
             "data.Reg1.RHep" = c(0.4, 0.35, 20, 1000, 800, 40000,6000),
             "Hep1N.data" = c(0.3, 0.35, 25, 1000, 800, 40000,6000),
             "Hep1R.data" = c(0.4, 0.35, 25, 1000, 800, 40000,6000),
             "Hep2N.data" = c(0.4, 0.35, 20, 1000, 800, 40000,6000),
             "Hep2R.data" = c(0.4, 0.35, 20, 1000, 800, 40000,6000),
             "HepRn.2d.data" = c(0.3, 0.35, 20, 1000, 800, 40000,6000),
             "HepRr.2d.data" = c(0.5, 0.35, 20, 1000, 800, 40000,6000),
             "NPC.Rn.2d.data" = c(0.25, 0.35, 20, 1000, 800, 40000,6000),
             "NPC.Rr.2d.data" = c(0.25, 0.35, 20, 1000, 800, 40000,6000),
             "NPCn.data" = c(0.25, 0.35, 20, 1000, 800, 40000,6000),
             "NPCr.data" = c(0.25, 0.35, 20, 1000, 800, 40000,6000),
             "HepRe.3d.data" = c(0.3, 0.35, 30, 1000, 800, 40000,6000),
             "HepRr.3d.data" = c(0.3, 0.35, 30, 1000, 800, 40000,6000),
             "NPC.Re.3d.data" = c(0.25, 0.35, 20, 1000, 800, 40000,6000),
             "NPC.Rr.3d.data" = c(0.25, 0.35, 20, 1000, 800, 40000,6000),
             "Data.Reg5_HepE" = c(0.4, 0.35, 40, 1000, 450, 40000,6000),
             "Data.Reg5_HepR" = c(0.4, 0.35, 40, 1000, 750, 40000,6000),
             "Data.Reg5_npcE" = c(0.25, 0.35, 25, 1000, 800, 40000,6000),
             "Data.Reg5_npcR" = c(0.25, 0.35, 25, 1000, 800, 40000,6000),
             "Data.Reg6_HepE" = c(0.4, 0.35, 25, 1000, 750, 40000,6000),
             "Data.Reg6_HepR" = c(0.4, 0.35, 25, 1000, 750, 40000,6000),
             "Data.Reg6_npcE" = c(0.25, 0.35, 25, 1000, 800, 40000,6000),
             "Data.Reg6_npcR" = c(0.25, 0.35, 25, 1000, 800, 40000,6000),
             "Data.Reg7_HepE" = c(0.4, 0.35, 25, 1000, 750, 40000,6000),
             "Data.Reg7_HepR" = c(0.4, 0.35, 25, 1000, 700, 40000,6000),
             "Data.Reg7_npcE" = c(0.25, 0.35, 25,1000,800,40000,6000),
             "Data.Reg7_npcR" = c(0.25, 0.35, 25, 1000, 800, 40000,6000),
                
             "H1" = c(0.3, 0.3, 5, 400, 300, 40000, 6000),
             "H3" = c(0.3, 0.3, 5, 400, 300, 40000, 6000),
             "H4" = c(0.3, 0.3, 5, 400, 300, 40000, 6000))
...
plotFilteredCells = function(l){
  ...
  plt = ggplot(all_meta, aes(x = frac_exp_tec,fill = keep_allfilt))+
